...
const AppointmentSchemaValidation = {
	book: Joi.object({
		...
		consultationFees: Joi.number()
			...
			.messages({
				"any.required": "ConsultationFees is required",
				"number.base": "ConsultationFees must be a number (not a string)",
				"number.positive": "ConsultationFees must be greater than 0",
				"number.integer": "ConsultationFees must be an integer value",
			}),
