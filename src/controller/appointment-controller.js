...
const AppointemntMiddleware = require("../middleware/appointment-middleware");
const CONSTANTS = require("../utils/constant");
const CustomResponse = require("../utils/custom-response");

router.post(
  "/book",
  AppointemntMiddleware.isAuthenticate,
  AppointemntMiddleware.bookValidate,
  function (req, res) {
...
router.get("/list", AppointemntMiddleware.isAuthenticate, function (req, res) {
  let tokenPayload = req.user;
